...
public abstract class CarController : MonoBehaviour
{
    ...
    [Header("Wheels")]
    [SerializeField] private Wheel _wheelFL;
    ...
    private void Steering()
    {
        ...
        _wheelFL.WheelCollider.steerAngle = Mathf.Lerp(_wheelFL.WheelCollider.steerAngle, steeringAngle, CarConfig.steeringSpeed);
        _wheelFR.WheelCollider.steerAngle = Mathf.Lerp(_wheelFR.WheelCollider.steerAngle, steeringAngle, CarConfig.steeringSpeed);
    }
